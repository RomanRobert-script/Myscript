...
function over(){
	...
	if (y != 6) {				
			...
			ball_1 = ball_1 + 0.4;
			var endOver = parseFloat(ball_1.toFixed(1));	

			if (endOver == 2 ){
				sco.classList.add("text-justify");
				sco.style.padding = "0 50px";
				document.getElementById("sco-1").innerHTML = "1st Innings Over";
				document.getElementById("sco-2").innerHTML = "RUNS"+" : "+run_1;
				document.getElementById("sco-3").innerHTML = "WICKET"+" : "+wkt_1;
				document.getElementById("sco-4").innerHTML = "EXTRAS"+" : "+extra;	
				// runs(endOver);
			}	
		}	
